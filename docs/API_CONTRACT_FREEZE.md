...
> **FREEZE NOTICE**: All 81 backend REST endpoints are frozen and certified for production handoff. 100% of frontend calls map cleanly to valid backend routes.
...
| `/api/v1/data/causal-inference` | POST | Point-in-Time Research Data | Run Causal Inference |
...
| `/api/v1/data/thesis-tracker/{symbol}` | GET | Point-in-Time Research Data | Get Thesis Tracker |
...
| `/api/v1/research/ai-committee/review` | POST | Next-Gen AI Committee & Intelligence | Run Ic Boardroom Review |
| `/api/v1/research/ai-committee/supply-chain/{symbol}` | GET | Next-Gen AI Committee & Intelligence | Get Supply Chain Graph |
| `/api/v1/research/cagr-matrix` | GET | Expert Strategy & Research Engines | Fetch Cagr Sensitivity Matrix |
| `/api/v1/research/genai-redteam/concall-audit` | POST | Phase 3 GenAI & Red-Team | Audit Concall Transcript |
| `/api/v1/research/genai-redteam/geopolitical-overlay/{symbol}` | GET | Phase 3 GenAI & Red-Team | Get Geopolitical Overlay |
| `/api/v1/research/genai-redteam/red-team-review` | POST | Phase 3 GenAI & Red-Team | Generate Red Team Review |
| `/api/v1/research/genai-redteam/stress-test` | POST | Phase 3 GenAI & Red-Team | Run Stress Test |
