...
try:
    ...
    from app.api import health, market, comparison, probability, options, strategies, query, research_data, watchlist, decision, watchlist_digest, monitoring, admin, portfolio, multibagger, technical, user_feedback, genai_redteam, ai_committee_api, turnaround
...
# Configure structured JSON logging if enabled in settings
if getattr(settings, "LOG_FORMAT", "text") == "json":
    class JSONFormatter(logging.Formatter):
        """Structured JSON log formatter for cloud-native log aggregation."""
...
app.include_router(turnaround.router, dependencies=auth_deps)
